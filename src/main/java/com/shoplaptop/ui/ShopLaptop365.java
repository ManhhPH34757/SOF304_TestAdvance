...
public class ShopLaptop365 extends JFrame {
	...
	public ShopLaptop365() {
		...
		JMenuItem mntmDanhSachPhieuDoi = new JMenuItem("DS PhieuDoi");
		mntmDanhSachPhieuDoi.setIcon(new ImageIcon(ShopLaptop365.class.getResource("/com/shoplaptop/icon/Notes.png")));
		mntmDanhSachPhieuDoi.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		mnQuanLy.add(mntmDanhSachPhieuDoi);
		...
		JButton btnDanhSachPhieuDoi = new JButton("DS Phiếu đổi");
		btnDanhSachPhieuDoi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new FormDanhSachPhieuDoi().setVisible(true);
			}
		});
		btnDanhSachPhieuDoi.setForeground(new Color(0, 0, 0));
		btnDanhSachPhieuDoi.setBackground(new Color(255, 255, 255));
		btnDanhSachPhieuDoi.setIcon(new ImageIcon(ShopLaptop365.class.getResource("/com/shoplaptop/icon/Notes.png")));
		btnDanhSachPhieuDoi.setVerticalTextPosition(SwingConstants.BOTTOM);
		btnDanhSachPhieuDoi.setHorizontalTextPosition(SwingConstants.CENTER);
		btnDanhSachPhieuDoi.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		toolBar.add(btnDanhSachPhieuDoi);
		
		JButton btnDSHoaDon = new JButton("DS Hóa đơn");
		btnDSHoaDon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new FormDSHoaDon().setVisible(true);
			}
		});
		btnDSHoaDon.setIcon(new ImageIcon(ShopLaptop365.class.getResource("/com/shoplaptop/icon/Price list.png")));
		btnDSHoaDon.setVerticalTextPosition(SwingConstants.BOTTOM);
		btnDSHoaDon.setHorizontalTextPosition(SwingConstants.CENTER);
		btnDSHoaDon.setForeground(Color.BLACK);
		btnDSHoaDon.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		btnDSHoaDon.setBackground(Color.WHITE);
		toolBar.add(btnDSHoaDon);
		...
		if (!Auth.isManager()) {
			...
			btnDanhSachPhieuDoi.setEnabled(false);
			mntmDanhSachPhieuDoi.setEnabled(false);
			btnDotGiamGia.setEnabled(false);
